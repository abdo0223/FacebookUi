                            ...
                            children: [
                              Expanded(
                                child: Column(
                                  children: [
                                    Expanded(
                                        child: buildRightSide(cubit.rights[0])),
                                    Expanded(
                                        child: buildRightSide(cubit.rights[1])),
                                    Expanded(
                                        child: buildRightSide(cubit.rights[2])),
                                    Expanded(
                                        child: buildRightSide(cubit.rights[3])),
                                    Expanded(
                                        child: buildRightSide(cubit.rights[4])),
                                    Expanded(
                                        child: buildRightSide(cubit.rights[5])),
                                  ],
                                ),
                              ),
                              SizedBox(
                              ...
                              Expanded(
                                ...
                                children: [
                                  Expanded(
                                      child: buildRightSide(cubit.rights[6])),
                                  Expanded(
                                      child: buildRightSide(cubit.rights[7])),
                                  Expanded(
                                      child: buildRightSide(cubit.rights[8])),
                                  Expanded(
                                      child: buildRightSide(cubit.rights[9])),
                                  Expanded(
                                      child: buildRightSide(cubit.rights[10])),
                                  Expanded(
                                      child: buildRightSide(cubit.rights[11])),
                                  Expanded(
                                      child: Padding(
